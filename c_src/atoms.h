...
extern ERL_NIF_TERM ATOM_STREAMING_ERROR;
extern ERL_NIF_TERM ATOM_LIMIT;
extern ERL_NIF_TERM ATOM_UNDEFINED;
extern ERL_NIF_TERM ATOM_ENCODING;
extern ERL_NIF_TERM ATOM_ERLANG_ENCODING;
extern ERL_NIF_TERM ATOM_MSGPACK_ENCODING;
